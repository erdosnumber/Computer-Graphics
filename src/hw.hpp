...
namespace COL781 {
    namespace OpenGL {
        ...
        public:
            ...
            void setTriangleIndices(Object &mesh, int n, const glm::ivec3* indices);

            // Sets the indices of the edges.
            void setEdgeIndices(Object &mesh, int n, const glm::ivec2* indices);
